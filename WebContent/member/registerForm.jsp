...
<script src="/shopping/member/register.js"></script>
   ...
   <ul>
      ...
      <li><label for="birth">생년월일</label>
          <input id="birth" name="birth" type="text" 
           size="20" placeholder="1995-12-07" maxlength="10">           
      ...
      <li><label for="phone">전화번호</label>
       ...
       <li><label for="name">이메일</label>
          <input id="email" name="email" type="text" 
           size="20" placeholder="asdf@naver.com" maxlength="10">          
