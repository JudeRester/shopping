$(document).ready(function(){
	$("#uRes").click(function(){//[회원가입]버튼 클릭
		window.location.href("/shopping/registerForm.do");
	});
	...
	$("#uUpdate").click(function(){//[회원 정보 변경]버튼 클릭
		window.location.href("/shopping/modify.do");
	});
	...
	$("#cart").click(function(){//[장바구니]버튼 클릭
		window.location.href("/shopping/cartList.do");
	});
	
	$("#buy").click(function(){//[구매내역]버튼 클릭
		window.location.href("/shopping/buyList.do");
	});
