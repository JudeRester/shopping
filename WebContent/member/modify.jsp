...
<c:if test="${empty sessionScope.id}">
  <meta http-equiv="Refresh" content="0;url=/shopping/index.do">
</c:if>

<div id="mStatus">
   <form id="uForm" method="post" action="/shopping/modifyForm.do">
    <ul>
   ...
   <form id="dForm" method="post" action="/shopping/deletePro.do">
    <ul>
        <li><label for="passwd">비밀번호</label>
            <input id="passwd" name="passwd" type="password" 
              size="20" placeholder="6~16자 숫자/문자" maxlength="16">
  ...
  <button id="shopMain" 
  onclick="window.location.href('/shopping/index.do')">메인으로</button>
</div>
